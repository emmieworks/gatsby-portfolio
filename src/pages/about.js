  ...
  return (
    ...
    <section id="profile" className={styles.profile}>
      ...
      <div className={styles.right}>
        ...
        主に、女性起業家さま、個人で活動されている方、法人さま向けに、WordPressでホームページを作成しています。<br />
    ...
    <div className={`container ${styles.container}`}>
      <h3>1. 人柄や価値観に寄りそい世界観を表現</h3>
      <p>お仕事で大切にしている思いなどをていねいにお聞きして、商品・サービスに宿る価値観を理解します。<br />
      伝えたい相手に、メッセージと魅力が届くように、わかりやすくコンテンツを整理し、デザインしていきます。</p>
