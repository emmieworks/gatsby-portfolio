    ...
    <Layout>
      ...
      <section className={styles.service}>
        ...
        <div className="container">
          ...
          これまで4年ほど女性起業家さんや中小企業主さんのホームページ作成・運営に数多く携わらせていただいています。</p>

          <p>そこで感じたのは、お客さま自身が「ホームページを育てる」スキルが大切だということ。</p>

          <p>特に、個人事業主であればサービスや発信内容の変化にあわせて、ホームページも自分でこまめに修正・更新していく必要があります。<br/>
